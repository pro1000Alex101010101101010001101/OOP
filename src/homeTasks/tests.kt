...
class TestCases {
    fun runTests() {
        ...
        if (person1.equals(person2)) println("Test 1 passed") else throw Exception("Test 1 failed")

            // Тест 2: Сравнение по ссылке
        if (!person1.equals(person2)) throw Exception("Test 2 failed") else println("Test 2 passed")
        ...
        if (person5.equals(person6)) println("Test 6 passed") else throw Exception("Test 6 failed")
        ...
        if (product1.equals(product2)) println("Test 7 passed") else throw Exception("Test 7 failed")

            // Тест 8: Сравнение по ссылке
        if (!product1.equals(product2)) throw Exception("Test 8 failed") else println("Test 8 passed")
        ...
        if (product5.equals(product6)) println("Test 12 passed") else throw Exception("Test 12 failed")
        ...
        if (person7.equals(person8)) println("Test 18 passed") else throw Exception("Test 18 failed")

        val product7 = Product("XYZ999", "Tablet")
        val product8 = Product("XYZ999", "Tab")

            // Тест 19: Сравнение по значению
        if (product7.equals(product8)) println("Test 19 passed") else throw Exception("Test 19 failed")
        ...
        if (product7.equals(product8)) println("Test 23 passed") else throw Exception("Test 23 failed")

            // Тест 24: Сравнение по ссылке
        if (person7.equals(person8)) println("Test 24 passed") else throw Exception("Test 24 failed")
    }
}
